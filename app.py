...
# CLEAN UI: HIDE MENUS AND TOOLBARS
hide_st_style = """
            <style>
...
def main_dashboard():
    ...
    with tab6:
        ...
        export_countries = st.multiselect("Include in Header:", options=list(COUNTRY_KEY_MAP.keys()), default=active_countries)
